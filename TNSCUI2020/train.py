...
from TNDataset import get_training_set, get_test_set
import torchvision
...
class option:
    def __init__(self):
        ...
        self.pretrain_net = "/dicom/Jone/data/TNSCUI2020/checkpoint/model_epoch_140.pth"
...
def train(epoch):
    ...
    for iteration, batch in enumerate(training_data_loader, 1):
        ...
        if iteration % 10 is 0:
            print(
                "===> Epoch[{}]({}/{}): Loss: {:.4f}".format(epoch, iteration, len(training_data_loader), loss.data[0]))
    imgout = input.data / 2 + 1
    torchvision.utils.save_image(imgout,
                                 "/dicom/Jone/data/TNSCUI2020/checkpoint/epch_" + str(epoch) + '.jpg')
...
def checkpoint(epoch):
    model_out_path = "/dicom/Jone/data/TNSCUI2020/checkpoint/model_epoch_{}.pth".format(epoch)
